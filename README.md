...
<a href="https://simplearmory.com/#/eu/blackrock/sunaru/collectable/mounts" target="_blank">
  <img src="https://img.shields.io/badge/WoW-Lockout%20Sharing-blueviolet?logo=blizzard" alt="WoW Lockout Sharing">
</a>
  
*By **Sunaru** | Updated: July 09, 2025*
...
3. Enter either of the following code: `YW4aN3OH4zx`

## 🚀 Getting a lockout

1. Make sure you're **not in a party** and standing **outside the instance** you want to join.
2. Whisper `/w Sunashare-Blackrock !sharing` to receive a lockout.
...
But if you feel like showing appreciation, feel free to mail gold to `Sunaru-Blackrock`.
...
## 🌟 Credits
Big thanks to **Fudrick** for Sharing the WeakAura<br>
Stole the GitHub Page from **Ywi**
